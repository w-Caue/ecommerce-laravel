<div class="space-y-7">
    <div class="bg-white p-7 rounded-2xl border border-neutral-200">
        <div class="flex items-center text-blue-500 gap-2 p-1">
            ...
            <h1 class="text-xl font-black uppercase">Promoção</h1>
                ...
                <ul class="splide__list">
                    @foreach ($products as $product)
                        <li wire:key="{{ $product->id }}" class="splide__slide"
                            onclick="javascript:location.href='{{ route('detalhe-produto', ['product' => $product->id]) }}'">
    ...
    <div class="bg-white p-7 rounded-2xl border border-neutral-200">
        <div class="flex items-center gap-2 text-orange-500 p-1">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                <path fill-rule="evenodd"
            ...
            <h1 class="text-xl font-black uppercase ">Destaques</h1>
        </div>
            ...
            <div class="splide__track">
                <ul class="splide__list">
                    @foreach ($destaques as $destaque)
                        <li wire:key="{{ $destaque->id }}" onclick="javascript:location.href='{{ route('detalhe-produto', ['product' => $destaque->id]) }}'" class="splide__slide"
                            onclick="javascript:location.href='{{ route('detalhe-produto', ['product' => $product->id]) }}'">
                            <div class="border border-neutral-200 w-56 rounded-xl cursor-pointer">
                                <div class="">
