<div class="flex flex-col gap-6">
    <x-auth-header :title="__('Acesse sua conta')" :description="__('Entre com seu email e senha')" />
    ...
    @if (Route::has('register'))
        <div class="space-x-1 rtl:space-x-reverse text-center text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <flux:link :href="route('register')" wire:navigate>{{ __('
            Inscrever-se') }}</flux:link>
        </div>
    @endif
</div>
